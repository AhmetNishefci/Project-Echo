export interface Country {
  ...
  dial: string;   // E.164 prefix (e.g., "+1")
  flag: string;   // Emoji flag
}

/**
 * Country list with emoji flags and dial codes.
 * Sorted alphabetically by name. Used by the phone login country picker.
 */
...
/** Find a country by ISO code, defaulting to US */
